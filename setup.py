...
"""Setup script for the Codimension IDE introspection plugin"""

import sys
import os.path
from setuptools import setup

description = 'Codimension IDE introspection plugin'

plugin_desc_file = 'ideintrospection.cdmp'

def getPluginVersion():
    """The version must be updated in the .cdmp file"""
    desc_file = os.path.join('cdmplugins', 'ideintrospection', plugin_desc_file)
...
setup(name='cdmideintrospectionplugin',
